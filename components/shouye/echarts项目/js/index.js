window.onload = function() {
    confirm('采用最新的Echarts技术结合HTML,CSS3技术设计开发，所有图形文字均是由点根据坐标一点点绘制而成，独具匠心！注意：由于功能限制，开发时不兼容移动端，建议用pc端进行浏览！如果您有好的建议或发现bug请联系恒仔')
    var t = null;
...
(function () {
  ...
  var option = {
      color: new echarts.graphic.LinearGradient(
          ...
          1,
          [
              {offset: 0, color: "#36b1c7"}, // 0 起始颜色
              {offset: 1, color: "#960b33"} // 1 结束颜色
          ]
      ),
      tooltip: {
          trigger: "item"
                ...
                data: [
                    {
                        ...
                        itemStyle: {
                            ...
                            color: new echarts.graphic.LinearGradient(
                                ...
                                1,
                                [
                                    {offset: 0, color: "#eeb422"}, // 0 起始颜色
                                    {offset: 1, color: "#8b1a1a"} // 1 结束颜色
                                ]
                            )
                        }
                    },
...
(function () {
    ...
    ${item.flag ? "icon-arrow-thick-up" : "icon-arrow-thick-down"}></s></span></li>`;
    });
    ...
    ${item.flag ? "icon-arrow-thick-up" : "icon-arrow-thick-down"}
    ></s></span></li>`;
        });
