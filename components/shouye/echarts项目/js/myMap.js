(function () {
    ...
    var color = ["#a6c84c", "#ffa022", "#46bee9",'#ff7f00','#cd3333','#ffff']; //航线的颜色
    var series = [];
    [
        ["西安", XAData],
        ["北京", BJData],
